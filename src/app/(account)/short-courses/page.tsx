...
import { getShortCourses } from "@/app/actions/program-actions";
  ...
  return (
    <div className="p-4 md:p-6 max-w-7xl mx-auto space-y-6">
      ...
      <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
        <div>
          <h1 className="text-3xl font-bold">Short Courses</h1>
          <p className="text-muted-foreground mt-1">
            Enhance your skills with our specialized short-term professional
            courses
          </p>
        </div>
      </div>
        ...
        <CardHeader className="pb-3 border-b">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-2">
              ...
              <CardTitle>Available Short Courses</CardTitle>
            </div>
            <CardDescription>
              {filteredPrograms.length}{" "}
              {filteredPrograms.length === 1 ? "course" : "courses"} found
            </CardDescription>
          </div>
        </CardHeader>
        <CardContent className="p-4">
          {isLoading ? (
            ...
            <EmptyState
              ...
              title="No short courses found"
              description={
                searchQuery || selectedCategory
                  ? "Try adjusting your search or filters to find what you're looking for."
                  : "There are currently no short courses available. Check back later for new courses."
              }
              actionLabel={
