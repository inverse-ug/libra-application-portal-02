...
const sponsorSchema = z.object({
  ...
  sponsorRelationship: z.string().min(2, { message: "Relationship is required" }),
  sponsorOccupation: z.string().min(2, { message: "Occupation is required" }),
  sponsorAddress: z.string().min(2, { message: "Physical address is required" }),
  ...
  nextOfKinAddress: z.string().min(2, { message: "Physical address is required" }),
...
export function ApplicationStepSponsor({ application, user, onComplete }: ApplicationStepSponsorProps) {
  ...
  return (
    <div className="space-y-6">
      <div>
        <h2 className="text-xl font-semibold mb-2">Sponsor & Next of Kin Information</h2>
        <p className="text-muted-foreground">Please provide details of your sponsor and next of kin.</p>
      </div>

      <Form {...form}>
        <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-8">
          <div>
            <h3 className="text-lg font-medium mb-4">Parent/Guardian/Sponsor Details</h3>
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    ...
                    <FormControl>
                      <Input placeholder="Enter sponsor's name" {...field} className="rounded-lg" />
                    </FormControl>
                    <FormMessage />
                  </FormItem>
                )}
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    ...
                    <FormControl>
                      <Input placeholder="Enter occupation" {...field} className="rounded-lg" />
                    </FormControl>
                    <FormMessage />
                  </FormItem>
                )}
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem className="md:col-span-2">
                    ...
                    <FormControl>
                      <Input placeholder="Enter physical address" {...field} className="rounded-lg" />
                    </FormControl>
                    <FormMessage />
                  </FormItem>
                )}
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    <FormLabel>Name</FormLabel>
                    <FormControl>
                      <Input placeholder="Enter next of kin's name" {...field} className="rounded-lg" />
                    </FormControl>
                    <FormMessage />
                  </FormItem>
                )}
