...
export function ApplicationStepEducation({
  application,
  user,
  onComplete,
}: ApplicationStepEducationProps) {
    ...
    <div className="space-y-6">
      <div>
        ...
        <p className="text-muted-foreground">
          Please provide details of your educational background, including
          primary, secondary schools, colleges, and universities attended.
        </p>
      </div>
